...
class Mock {
    ...
    private val langPt = MotivationConstants.LANGUAGES.langPt
    private val langFr = MotivationConstants.LANGUAGES.langFr
    private val langEn = MotivationConstants.LANGUAGES.langEn
